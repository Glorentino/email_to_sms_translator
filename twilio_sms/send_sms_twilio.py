...
account_sid = os.environ['TWILIO_ACCOUNT_SID']="" #Enter twilio account sid in str
auth_token = os.environ['TWILIO_AUTH_TOKEN']="" # Enter twilio account auth token in str
